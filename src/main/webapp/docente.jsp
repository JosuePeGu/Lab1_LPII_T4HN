     				 ...
     				 <div class="modal-body">
     				 	<form id="formDocente">
							<div class="form-group">
								<label for="exampleNombre" class="form-label">Nombres</label>
								<input type="text" class="form-control" name="nombre">
							</div>
							<div class="form-group">
								<label for="examplePaterno" class="form-label">Apellido Paterno</label>
								<input type="text" class="form-control" name="paternoz">
							</div>
							<div class="form-group">
								<label for="exampleMaterno" class="form-label">Apellido Materno</label>
